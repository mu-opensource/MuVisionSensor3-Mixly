...
//Vision type
Blockly.LKL_VS2_VISION_COLOR = '颜色';
Blockly.LKL_VS2_VISION_COLOR_DETECT = '颜色检测';
...
Blockly.LKL_VS2_GET_VISION_RESULT = '捕获到识别结果';
Blockly.LKL_VS2_GET_PIX_COLOR = '捕获坐标';
Blockly.LKL_VS2_X_POSITION = '横向坐标';
Blockly.LKL_VS2_Y_POSITION = '纵向坐标';
Blockly.LKL_VS2_CARD_TYPE = '卡片类型';
Blockly.LKL_VS2_SET_DETECT_COLOR = '设置识别颜色';
Blockly.LKL_VS2_SET_X_VALUE = '设置坐标X值';
Blockly.LKL_VS2_SET_Y_VALUE = '设置坐标Y值';
